...
file <- "/Users/janwinter/OneDrive/PhD/Followup/Results/qPCR/2017-04-14_HEK_BCAT-Wnt_GSK/2017-04-14_JW_FOLLOWUP_HEK_px459-BCAT-WNT-GSK.txt"
...
file_xlsx <- "/Users/janwinter/OneDrive/PhD/Followup/Results/qPCR/2017-04-14_HEK_BCAT-Wnt_GSK/qPCR_Overview_MASTER.xlsx"
...
qpcR::efficiency(calc[[c("A1")]]$fitted, plot=TRUE, type = "Cy0")
...
qPCRraw <- HTqPCR::readCtData(files = n_samples$Files, path=getwd(), column.info = list("position" = 1,"feature" = 2,"Ct" = 4, "type"=5, "flag" = 6), n.features = n_features)
# 
