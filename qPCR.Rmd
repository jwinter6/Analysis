...
qPCRnorm <- normalizeCtData(qPCRraw, norm = "deltaCt", Ct.max = maxCT, deltaCt.genes = c("GAPDH","PGK1"))
...
getCt(qPCRraw)
getCt(qPCRnorm)
plot(exprs(qPCRraw), exprs(qPCRnorm), pch = 20, main = "deltaCT normalisation", col = rep(brewer.pal(6, "Spectral"), each = 96))
